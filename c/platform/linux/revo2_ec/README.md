# Revo 2 - EtherCAT Examples (Standalone)

**Note:** This library does NOT depend on Stark SDK. It uses IgH EtherCAT Master directly for low-level PDO/SDO operations. For SDK-based EtherCAT examples, see `../revo2/`.
