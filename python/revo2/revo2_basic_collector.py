"""
Revo2 Basic Version - High-Performance Data Collector Example with Trajectory Control
...
Usage:
    python revo2_basic_collector.py
"""
...
async def main():
    ...
    motor_frequency = 100 if is_linux else 20  # Motor frequency
    ...
    # Start data processing task with interval matching collection frequency
