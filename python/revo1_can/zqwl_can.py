...
class Revo1CanController:
    ...
    async def configure_turbo_mode(self):
        ...
        try:
            ...
            turbo_duration = 300  # Grip duration (milliseconds)
    ...
    async def finger_position_examples(self):
        ...
        # Example 1: Each finger grip action
        logger.info("Example 1: Each finger grip action")
        positions = [
            [200, 0, 0, 0, 0, 0],  # Thumb
            [200, 300, 0, 0, 0, 0],  # Thumb + Index finger
            [200, 300, 500, 0, 0, 0],  # + Middle finger
            [200, 300, 500, 700, 0, 0],  # + Ring finger
            [200, 300, 500, 700, 800, 0],  # + Pinky finger
        ...
        grab_sequence = [
            ...
            ([600, 700, 900, 1000, 1000, 0], "Grab completion"),
        ]
    ...
    async def demo_task(self):
        ...
        # Configure device parameters, uncomment to enable as needed
        ...
        if self.is_revo1_advanced_touch():
            ...
            # Uncomment to enable the following demos as needed
            ...
            # Set final gesture (packing gesture)
