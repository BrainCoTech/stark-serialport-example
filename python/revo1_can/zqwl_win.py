...
def zcan_open(device_type: int, channel: int, baudrate: int):
    ...
    try:
        ...
        chn_cfg.config.can.timing0 = 0x00  # 波特率时序0 (1Mbps)
        chn_cfg.config.can.timing1 = 0x1C  # 波特率时序1 (80%采样点)
...
def revo1_can_receive_message(quick_retries: int = 2, dely_retries: int = 0):
    """
