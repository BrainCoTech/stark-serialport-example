...
int main(int argc, char const *argv[]) {
  ...
  // Option 1: connect multiple devices through a single serial port (each
  // device must have a unique ID)
  uint8_t slave_id_1 =
      0x7e; // Default left-hand ID is 0x7e, right-hand ID is 0x7f
  ...
  // Loop to control finger positions, for testing only; a very short delay may
