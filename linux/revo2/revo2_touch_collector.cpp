...
/**
 * Revo2 Touch (Capacitive) - High-Performance Data Collector Example
 * 
 ...
 * - Capacitive touch sensor data collection at 100Hz (Linux) or 20Hz (Windows/macOS)
 ...
 * 
 * Compile:
 *   make revo2_touch_collector
 * 
 * Run:
 *   ./revo2_touch_collector
 */
...
int main(int argc, char const *argv[]) {
  ...
  // Linux: 100Hz motor, 100Hz touch (high-performance)
  // Other platforms: 20Hz motor, 20Hz touch (conservative)
  #ifdef __linux__
    const uint32_t motor_frequency = 100;  // Linux: 100Hz
    const uint32_t touch_frequency = 100;  // Linux: 100Hz
  #else
    const uint32_t motor_frequency = 20;   // Windows/macOS: 20Hz
    const uint32_t touch_frequency = 20;   // Windows/macOS: 20Hz
  #endif
