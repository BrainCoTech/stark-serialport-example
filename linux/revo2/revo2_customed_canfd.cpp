...
int main(int argc, char const *argv[])
{
  ...
  init_cfg(STARK_HARDWARE_TYPE_REVO2_BASIC, STARK_PROTOCOL_TYPE_CAN_FD, LOG_LEVEL_INFO, 1024);
  ...
  auto handle = canfd_open(5000000, 1, 0x7f); // Open CAN FD with baudrate 5Mbps, left hand ID 0x7e, right hand ID 0x7f
