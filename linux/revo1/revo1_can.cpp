...
int main(int argc, char const *argv[])
{
  ...
  init_cfg(STARK_HARDWARE_TYPE_REVO1_BASIC, STARK_PROTOCOL_TYPE_CAN, LOG_LEVEL_INFO, 1024);
  ...
  auto handle = can_open(1000000, 1, 1); // Open CAN with baudrate 1Mbps, master_id=1, slave_id=1
