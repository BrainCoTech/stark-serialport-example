...
private:
    // ROS 2 Services
    rclcpp::Service<ros2_stark_interfaces::srv::GetDeviceInfo>::SharedPtr get_device_info_service_left;
    rclcpp::Service<ros2_stark_interfaces::srv::GetDeviceInfo>::SharedPtr get_device_info_service_right;
    rclcpp::Service<ros2_stark_interfaces::srv::SetMotorMulti>::SharedPtr set_motor_multi_service_left;
    rclcpp::Service<ros2_stark_interfaces::srv::SetMotorMulti>::SharedPtr set_motor_multi_service_right;
    rclcpp::Service<ros2_stark_interfaces::srv::SetMotorSingle>::SharedPtr set_motor_single_service_left;
    rclcpp::Service<ros2_stark_interfaces::srv::SetMotorSingle>::SharedPtr set_motor_single_service_right;
    
    // ROS 2 Publishers
    rclcpp::Publisher<ros2_stark_interfaces::msg::MotorStatus>::SharedPtr motor_status_pub_left;
    rclcpp::Publisher<ros2_stark_interfaces::msg::MotorStatus>::SharedPtr motor_status_pub_right;
    // rclcpp::Publisher<ros2_stark_interfaces::msg::TouchStatus>::SharedPtr touch_status_pub_left;
    // rclcpp::Publisher<ros2_stark_interfaces::msg::TouchStatus>::SharedPtr touch_status_pub_right;

    // ROS 2 Subscribers
    rclcpp::Subscription<ros2_stark_interfaces::msg::SetMotorMulti>::SharedPtr motor_multi_sub_left;
    rclcpp::Subscription<ros2_stark_interfaces::msg::SetMotorMulti>::SharedPtr motor_multi_sub_right;
    rclcpp::Subscription<ros2_stark_interfaces::msg::SetMotorSingle>::SharedPtr motor_single_sub_left;
    rclcpp::Subscription<ros2_stark_interfaces::msg::SetMotorSingle>::SharedPtr motor_single_sub_right;
